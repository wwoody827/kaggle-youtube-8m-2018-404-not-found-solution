...
class CrossEntropyLossDistill(BaseLoss):
  """Calculate the cross entropy loss between the predictions and labels.
  """
  def calculate_loss(self, predictions, labels, distill_label, p=0.5):
    ce_loss_fn = CrossEntropyLoss()
    cross_entropy_loss = ce_loss_fn.calculate_loss(predictions, labels)
    cross_entropy_loss2 = ce_loss_fn.calculate_loss(predictions, distill_label)
    return cross_entropy_loss * (1.0 - p) + cross_entropy_loss2 * p
