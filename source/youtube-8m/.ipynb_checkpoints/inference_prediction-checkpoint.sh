...
do
  ...
  do
    CUDA_VISIBLE_DEVICES=0 python inference_prediction.py --input_data_pattern=$file  --train_dir="run/$train_dir" --batch_size=100 --output_dir="/media/woody/Data2T/youtube-8m/prediction/prediction_train/$train_dir" --file_size=10000                                                            
  done
done