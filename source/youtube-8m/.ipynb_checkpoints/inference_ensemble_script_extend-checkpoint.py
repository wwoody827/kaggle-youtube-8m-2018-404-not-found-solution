...
data_config="ensemble/ensemble_infer_on_train_extend.config"

train_dir = "run/ensemble/0704_MoeModel_1"
output_dir="/media/woody/Data2T/youtube-8m/prediction/prediction_train_ensemble/0704_MoeModel_1_extend/"
